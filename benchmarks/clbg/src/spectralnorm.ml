 ...
 * Contributed by Sebastien Loisel, Troestler Christophe, Mauricio Fernandez.
 *
 * Kept sequential (the canonical OCaml entry is sequential; the parallel
 * CLBG variants split the row loops, which we leave as a future option). *)
